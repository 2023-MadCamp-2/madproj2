...
const HistoryListPage = ({ navigation }) => {
  ...
  const chats = [
    { id: 1, nickname: '아기공룡둘리', name: '박진아', image: require('../../images/profile1.jpeg'), lastMessage: '안녕하세요' },
    { id: 2, nickname: '검정기영이', name: '하도영', image: require('../../images/profile2.jpeg'), lastMessage: '잘 지내고 있어요' },
    { id: 3, nickname: '응답했다덕선이', name: '성덕선', image: require('../../images/profile3.jpeg'), lastMessage: '오늘 저녁 뭐 먹을까요?' },
    // ... 나머지 채팅방
  ];
